                                 ...
                                 GtkTextDirection  direction)
{
  ...
  if (font_rendering == GTK_FONT_RENDERING_MANUAL)
  ...
  else
    {
      ...
      if (font_rendering == GTK_FONT_RENDERING_AUTOMATIC)
        {
          double dpi = 96.;
          GdkSurface *surface;
          ...
          if (dpi < 200.)
            font_rendering = GTK_FONT_RENDERING_PREFER_SHARPNESS;
          else
            font_rendering = GTK_FONT_RENDERING_PREFER_POSITIONING;
        }
      ...
      if (font_rendering == GTK_FONT_RENDERING_PREFER_POSITIONING)
        {
