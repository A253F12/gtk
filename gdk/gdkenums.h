...
typedef enum {
  GDK_CONTENT_TRANSFORM_NORMAL,
  GDK_CONTENT_TRANSFORM_90,
  GDK_CONTENT_TRANSFORM_180,
  GDK_CONTENT_TRANSFORM_270,
  GDK_CONTENT_TRANSFORM_FLIPPED,
  GDK_CONTENT_TRANSFORM_FLIPPED_90,
  GDK_CONTENT_TRANSFORM_FLIPPED_180,
  GDK_CONTENT_TRANSFORM_FLIPPED_270,
} GdkContentTransform;
